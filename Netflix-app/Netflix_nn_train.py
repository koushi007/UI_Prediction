...
model.fit(X_train, y_train, epochs=500, batch_size=12,validation_split = 0.2,verbose=None,callbacks=[my_callback])
# evaluate the model
...
model.save('Netflix-toy{}'.format(acc))